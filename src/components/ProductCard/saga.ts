...
import { TOGGLE_PRODUCT_SELECTION_PANEL_SAGA } from '../../actions/types'
...
export function* toggleProductSelectionPanel({
  firstNames,
  lastNames,
  birthDate,
  password,
...
export function* toggleProductSelectionPanelSagas() {
  yield takeLatest(
    TOGGLE_PRODUCT_SELECTION_PANEL_SAGA,
